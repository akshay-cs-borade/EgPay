...
class InvoiceItemsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create invoice_item" do
    assert_difference("InvoiceItem.count") do
      post invoice_items_url, params: { invoice_item: { line_total: @invoice_item.line_total, quantity: @invoice_item.quantity, unit_price: @invoice_item.unit_price } }
    end
  ...
  test "should update invoice_item" do
    patch invoice_item_url(@invoice_item), params: { invoice_item: { line_total: @invoice_item.line_total, quantity: @invoice_item.quantity, unit_price: @invoice_item.unit_price } }
